use crate::buffer::{Buffer, BufferAny, BufferMutSlice, BufferSlice, BufferType, RawBufferPackage};
...
/// Raw package for index buffers.
pub struct RawIndexPackage<T: Index> {
